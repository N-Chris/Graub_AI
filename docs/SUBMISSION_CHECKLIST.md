...
- [ ] `docs/DEPLOYMENT.md` filled in with a real Alibaba Cloud proof link
...
- [ ] `run_comparison.py` executed at least once; `comparison_results.json` committed or numbers pasted into the written submission
- [ ] Written project description explicitly names **Track 3: Agent Society**
